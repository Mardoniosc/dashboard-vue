  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      >
        ...
        <pre v-else>&lt;script scr="https://mardoniosc-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt; &lt;/script&gt;</pre>
  ...
  setup () {
    ...
    async function handleGenerateApiKey () {
      try {
        ...
        const { data } = await services.users.regenerateApiKey()
